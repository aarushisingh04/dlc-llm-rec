...
def main(
    ...
    control_GP: str = None, # "GP10_1_-1_5e-4_0.05_GP1000gred"
    batch_size: int=16,
    num_beams: int=1,
    ...
    with open(test_data_path, 'r') as f:
        ...
        instructions = [_['instruction'] for _ in test_data] if control_GP == None else [_['instruction_controlGP'][control_GP] for _ in test_data]
        ...
        for i, test in tqdm(enumerate(test_data)):
            ...
            if control_GP != None:
                test_data[i]['control_GP'] = control_GP
